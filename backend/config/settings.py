"""
Django settings for ClassyCouture backend.
"""
...
INSTALLED_APPS = [
    'daphne',  # Channels ASGI application server - must be first
...
if DB_ENGINE == 'django.db.backends.postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'classycouture'),
            'USER': os.getenv('DB_USER', 'classyuser'),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@classycouture.com')
